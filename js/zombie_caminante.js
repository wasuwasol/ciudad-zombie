...
let ZombieCaminante = function(sprite, x, y, ancho, alto, velocidad, rangoMov) {
...
ZombieCaminante.prototype.comenzarAtaque = function (jugador) {
  if (!this.atacando) {
    this.atacar(jugador);
  }
  this.atacando = true;
...
ZombieCaminante.prototype.dejarDeAtacar = function () {
  this.atacando = false;
};